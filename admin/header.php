	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">The CAFE</span>
			</a>
    ...
    <!-- Top Bar ... User Inforamtion .. Login/Log out Area -->
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li class="d-flex">		
							<a href="logout.php" class="hidden-xs">Log out</a>
						</li>
					</ul>
				</div>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
					...
					<li class="treeview <?php if( ($cur_page == 'messages.php') || ($cur_page == 'customer-add.php') || ($cur_page == 'customer-edit.php') ) {echo 'active';} ?>">
			          <a href="messages.php">
			            <i class="fa fa-user-plus"></i> <span>Messages Customer</span>
			          </a>
			        </li>
